...
public class homeController {
    ...
    public ModelAndView actCliente(HttpServletRequest request){
        ...
        /* mav.addObject("cliente", new Cliente (id, cli.getNombre(), cli.getDireccion(), cli.getCorreo(), cli.getTelefono(), cli.getSalario(), cli.getFoto() ));*/
    ...
    /* @RequestMapping(value="agregarCliente.htm", method=RequestMethod.POST)
    public ModelAndView agregarCliente(HttpServletRequest request){
